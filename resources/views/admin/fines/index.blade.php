...
@section('content')
    <div class="mb-8 flex justify-between items-center">
        <div>
            <h1 class="text-4xl font-bold text-gray-900">Kelola Denda</h1>
        ...
        <form action="{{ route('admin.fines.index') }}" method="GET"
            ...
            <div>
                ...
                <select name="status" class="w-full px-4 py-2 border border-gray-300 rounded-lg">
                    <option value="">Semua</option>
                    @foreach(\App\Models\Fine::statusOptions() as $value => $label)
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('admin.fines.index') }}"
                    class="bg-gray-400 hover:bg-gray-500 text-white px-4 py-2 rounded-lg font-medium">Atur Ulang</a>
            </div>
        </form>
    </div>
