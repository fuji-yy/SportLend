...
@section('content')
<div class="mb-8">
    <h1 class="text-4xl font-bold text-gray-900">Kembalikan Buku</h1>
    <p class="text-gray-600">Catat pengembalian buku yang anda pinjam</p>
    <div class="mt-6">
    ...
    <div>
        <div class="bg-white rounded-lg shadow p-6 sticky top-8">
            ...
            <form method="POST" action="{{ route('peminjam.returns.store', $borrowing) }}">
                ...
                <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-lg font-medium">Kembalikan Buku</button>
            </form>
        </div>
    </div>
</div>
