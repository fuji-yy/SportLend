...
<div class="mb-8">
    ...
    <p class="text-gray-600">Selamat datang di halaman peminjam SportLend</p>
</div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <a href="{{ route('peminjam.tools.index') }}" class="flex items-center h-full">
            <div class="p-3 rounded-full bg-purple-100 mr-4">
                <svg class="w-8 h-8 text-purple-600" fill="currentColor" viewBox="0 0 24 24"><path d="M19 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h4l3 3 3-3h4c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14h-4l-3 3-3-3H5V4h14v12z"/></svg>
            </div>
            <div>
                <p class="text-gray-600 text-sm">Cari Alat</p>
